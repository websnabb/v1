...
import { d as getStaticPathsBlogList, e as blogListRobots } from '../../chunks/blog_uuUOVLFc.mjs';
...
` })} ${renderComponent($$result2, "BlogList", $$List, { "posts": page.data })} ${renderComponent($$result2, "Pagination", $$Pagination, { "prevUrl": page.url.prev, "nextUrl": page.url.next })} <!--
    ...
    --> </section> ` })}`;
}, "/Users/jmenor/Github/astrowind-main/src/pages/[...blog]/[...page].astro", void 0);

const $$file = "/Users/jmenor/Github/astrowind-main/src/pages/[...blog]/[...page].astro";
const $$url = "/websnabb/[...blog]/[...page]";
